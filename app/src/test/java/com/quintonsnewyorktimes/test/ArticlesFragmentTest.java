...
import com.quintonsnewyorktimes.connection.NetworkService;
...
@PrepareForTest({NYT_App.class, ArticlesFragment.class, MainActivity.class
        , ProgressDialog.class, com.quintonsnewyorktimes.connection.Service.class, NetworkService.class})
public class ArticlesFragmentTest {
    ...
    @Mock
    private NYT_App mockApplication;
    ...
    @Mock
    private com.quintonsnewyorktimes.connection.Service service;

    @Mock
    private NetworkService networkService;

    @Mock
    private NYT_App application;
    ...
    public void setUp() throws Exception {
        ...
        service = new com.quintonsnewyorktimes.connection.Service(networkService);
    ...
    public void testOnCreateView() throws Exception {
        ...
        verify(mockLayoutInflater, times(1)).inflate(R.layout.articles_list, mockViewGroup, false);
    }
