package com.quintonsnewyorktimes.articles_adapter;
...
import com.quintonsnewyorktimes.app_utilities.FragmentHelper;
import com.quintonsnewyorktimes.fragments.ArticleDetailFragment;
...
public class ArticlesAdapter extends RecyclerView.Adapter<ArticlesAdapter.ViewHolder> {
    ...
    public ArticlesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        LayoutInflater inflater = LayoutInflater.from(
                parent.getContext());
        View v =
                inflater.inflate(R.layout.single_article_row, parent, false);
